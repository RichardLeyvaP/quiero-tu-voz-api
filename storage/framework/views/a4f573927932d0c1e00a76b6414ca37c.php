...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $assetPathPrefix; ?>css/theme-elements.style.css" media="screen">
    <link rel="stylesheet" href="<?php echo e(asset('css/docco.min.css')); ?>" media="screen">

    <script type="text/javascript" src="<?php echo e(asset('js/lodash.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/highlight.min.js')); ?>"></script>
    ...
    <script type="module">
        import {
            CodeJar
        } from "<?php echo e(asset('js/codejar.js')); ?>"
    ...
    <style>
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url("<?php echo e(asset('fonts/pt-sans-v17-latin-regular.woff2')); ?>") format('woff2'),
            /* Chrome 36+, Opera 23+, Firefox 39+ */
            url("<?php echo e(asset('fonts/pt-sans-v17-latin-regular.woff')); ?>") format('woff');
...
<body>
    ...
    <div class="sl-elements sl-antialiased sl-h-full sl-text-base sl-font-ui sl-text-body sl-flex sl-inset-0">
        ...
        <?php echo $__env->make("scribe::themes.elements.sidebar", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="sl-overflow-y-auto sl-flex-1 sl-w-full sl-px-16 sl-bg-canvas sl-py-16" style="max-width: 1500px;">
            ...
            <div class="sl-mb-10">
                <div class="sl-mb-4">
                    ...
                    <a title="Download Postman collection" class="sl-mx-1" href="<?php echo $metadata['postman_collection_url']; ?>" target="_blank">
                        <small>Postman collection →</small>
                    </a>
                    <?php endif; ?>
                    <?php if($metadata['openapi_spec_url']): ?>
                    <a title="Download OpenAPI spec" class="sl-mx-1" href="<?php echo $metadata['openapi_spec_url']; ?>" target="_blank">
            ...
            <?php echo $__env->make("scribe::themes.elements.groups", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH C:\Users\Richard\Documents\GitHub\quiero-tu-voz-api\resources\views/vendor/scribe/themes/elements/index.blade.php ENDPATH**/ ?>