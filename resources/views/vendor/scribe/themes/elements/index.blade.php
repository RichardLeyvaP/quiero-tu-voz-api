...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/docco.min.css') }}" media="screen">
    ...
    <style>
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url("{{ asset('fonts/pt-sans-v17-latin-regular.woff2') }}") format('woff2'),
            /* Chrome 36+, Opera 23+, Firefox 39+ */
            url("{{ asset('fonts/pt-sans-v17-latin-regular.woff') }}") format('woff');
        ...
        <div class="sl-overflow-y-auto sl-flex-1 sl-w-full sl-px-16 sl-bg-canvas sl-py-16" style="max-width: 1500px;">
            ...
            <div class="sl-mb-10">
                <div class="sl-mb-4">
                    ...
                    <a title="Download Postman collection" class="sl-mx-1" href="{!! $metadata['postman_collection_url'] !!}" target="_blank">
